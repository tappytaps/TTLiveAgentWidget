...
For better performance and security we recommend to use a proxy server. See documentation of [TTLiveAgentWidget - proxy server](liveagent-proxyserver/README.md).
